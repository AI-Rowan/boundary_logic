...
#'       counterfactual is subsequently generated by \code{\link{bl_sparse_cf}},
...
#'       \code{NULL}. Stored so that \code{\link{bl_sparse_cf}} can identify
...
#' \code{\link{bl_find_boundary_local}} using the same biplotEZ pipeline as
